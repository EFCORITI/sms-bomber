...
print(Fore.CYAN + " ")
print("""                      
 _____ _____ ____ ___  ____  ___ _____ ___
| ____|  ___/ ___/ _ \|  _ \|_ _|_   _|_ _|
|  _| | |_ | |  | | | | |_) || |  | |  | |
| |___|  _|| |__| |_| |  _ < | |  | |  | |
|_____|_|   \____\___/|_| \_\___| |_| |___|



[Codeinged by Ali or Efcoriti]
...
ID Telegram and Rubika : @efcoriti
The Script Was Created by Efcoriti
...
def shad(phone):
    ...
    try:
        ...
        if "OK" in shadR.text:
            ...
            print ("In yeki naraft to konesh :(")
    except:
        print ("In yeki naraft to konesh :(")
...
try:
    phone = str(input("↦Target Phone (09*********): "))
    while True:
